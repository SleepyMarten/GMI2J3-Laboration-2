namespace KeesTalksTech.Utilities.Latin.Numerals
{
    ...
    public class RomanNumeral
    {
        ...
        public string ToString(RomanNumeralNotation notation)
        {
            ...
            {
                throw new ArgumentOutOfRangeException(nameof(Number), "Number should be under 5000(max 4999)");
            }
            else
            {
        ...
        //        try
        //        {
        //            // calls that can make the program/lib crash. It should inform about errors and/ or show exceptions, but newer crash!
